...
function require_fused_qkv_norm_rope_vnorm_kvcache_op() {
...
PY
  ...
  echo "Missing torch.ops.vllm.fused_qkv_norm_rope_vnorm_and_unified_kv_cache_update in the Python Triton registration path." >&2
