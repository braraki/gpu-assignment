...
- `Part-3-qk-norm-rope-fusion.md`: attention-prep fusion report, source mapping, Part 1 baseline references, and the phased Q/K control plus new QKV fusion plan
- `scripts/part2_decoder_fusion/`: Part 2 run scripts for the decoder-residual-fusion benchmark and `nsys`
- `scripts/part3_qk_norm_rope_fusion/`: Part 3 run scripts for the Q/K control and QKV attention-prep fusion benchmark family
...
- `Documentation/qk_norm_rope_fusion.md`: step-6 follow-on notes for the Q/K control path and the new QKV attention-prep fusion direction
